...
//            Connection conn = jdbcTemplate.getDataSource().getConnection();
            ...
            String sql = "UPDATE user_example SET last_login_time=? WHERE user_name =?";
            jdbcTemplate.update(sql, 111111, userName);
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext-conn.xml");
